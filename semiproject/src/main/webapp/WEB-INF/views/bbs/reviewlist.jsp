...
int bbsPage = (Integer)request.getAttribute("reviewbbsPage");

int pageNumber = (Integer)request.getAttribute("reviewpageNumber");
System.out.println(pageNumber);

List<BbsDto> list = (List<BbsDto>)request.getAttribute("reviewbbslist");
%>    
...
<div class="container text-center" align="center">
        ...
        <br>
        <h2><a href="review.do" style="text-decoration: none">여행 후기 게시판</a></h2>
</div>
      ...
      <tr>
         ...
         <td>
            ...
            if(bbs.getDel() == 0){
               ...
               <a href="reviewbbsdetail.do?seq=<%=bbs.getSeq() %>&name=<%=name %>"><%=dot3(bbs.getTitle() ) %></a> 
...
%>
   <br>   
   <a href="reviewbbswrite.do">글쓰기</a> <!-- 글쓰기 링크를 누르면 글을 작성하는 페이지인 bbswrite.jsp로 이동한다. -->
</div>
<%
}
%>
...
function goPage( pageNum ) {
	   ...
	   // 검색과 페이징은 같이 가야된다.
	   location.href = "review.do?choice=" + choice + "&search=" + search + "&pageNumber=" + pageNum;
	}
