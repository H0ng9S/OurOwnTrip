...
<jsp:include page="reviewreplylist.jsp" flush="false"/>
...
%>
	<div align="center">
		...
		<form action="writereviewreply.do" method="post">
...
function updatebbs(seq) {
	location.href = "reviewbbsupdate.do?seq=" + seq; // 수정 버튼을 눌렀을 때 실행되는 함수, bbsupdate.jsp로 seq값을 가지고 이동
}
function deletebbs(seq,sort) {
	location.href = "reviewbbsdelete.do?seq=" + seq; // 삭제 버튼을 눌렀을 때 실행되는 함수, bbsdelete.jsp로 seq값을 가지고 이동
}
